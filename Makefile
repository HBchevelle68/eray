...
ASAN_LIBS = -lasan
DEPS= $(addprefix $(INCLUDE)/, e32.h e64.h shared.h )
ROBJS=$(addprefix $(SRC)/, eray.o e32.o e64.o shared.o)
DOBJS=$(addprefix $(SRC)/, eray-debug.o e32-debug.o e64-debug.o shared.o)
